...
public class Main {
    public static void main(String[] args) {
        ...
        recipe.build(recipe.new builder().setAmount(12).setAuthor("My culito").setDietType("Celiac").setDifficulty(44)
        ...
        recipe1.build(recipe1.new builder().setAmount(11).setAuthor("La perra").setDietType("Celiac").setDifficulty(45)
        ...
        recipe2.build(recipe2.new builder().setAmount(11).setAuthor("La perra").setDietType("Celiac").setDifficulty(1)
